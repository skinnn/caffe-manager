...
export default {
	...
	props: {
		// Determines if it's 'create' or 'update' user form
		type: {
			type: String,
			required: true,
			validator: function(value) {
				// The value must match one of these strings
				return ['update', 'create'].indexOf(value) !== -1
			}
		},
		editMode: {
			type: Boolean,
	...
	async mounted() {
		// If 'update' prop is passed component is acting as View/Edit user form, otherwise as Create user form
		if (this.$props.type === 'update') this.form.mode = 'update'
